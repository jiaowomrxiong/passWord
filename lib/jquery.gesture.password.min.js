!function (a) {
    function b(b, d) {
        return this.each(function () {
            var e = a(this), f = a.extend({}, c.DEFAULTS, "object" == typeof b && b), g = e.data("GesturePasswd"), h = "string" == typeof b ? b : 0 / 0;
    ...
    var c = function (b, c) {
        ...
        this.result = "", this.pList = [], this.sList = [], this.tP = new e(0, 0), this.$element.append('<canvas class="main-c" width="' + c.width + '" height="' + c.height + '" >'), this.$c = a(this.id + " .main-c")[0], this.$ctx = this.$c.getContext("2d"), this.initDraw = function () {
            ...
            for (var a = 0; 3 > a; a++)for (var b = 0; 3 > b; b++) {
            ...
            for (var c in d.pList)if (Math.pow(a - d.pList[c].x, 2) + Math.pow(b - d.pList[c].y, 2) < Math.pow(this.rr, 2))return d.pList[c];
            return 0
            ...
            if (arguments.length > 0 && (d.$ctx.strokeStyle = a, d.$ctx.fillStyle = a), d.sList.length > 0)for (var b in d.sList)0 != b ? (d.$ctx.lineTo(d.sList[b].x, d.sList[b].y), console.log(d.sList[b].x, d.sList[b].y)) : (console.log(d.sList[b].x, d.sList[b].y), d.$ctx.moveTo(d.sList[b].x, d.sList[b].y))
            ...
            for (var c in b)if (a.x == b[c].x && a.y == b[c].y)return ++c;
            return !1
        }, this.touched = !1, a(this.id).on("mousedown touchstart", {that: d}, function (a) {
            a.data.that.touched = !0
        }), a(this.id).on("mouseup touchend", {that: d}, function (c) {
        ...
        }), a(this.id).on("touchmove mousemove", {that: d}, function (a) {
            if (a.data.that.touched) {
                var b = a.pageX || a.originalEvent.targetTouches[0].pageX, c = a.pageY || a.originalEvent.targetTouches[0].pageY;
        ...
        }), a(this.id).on("passwdWrong", {that: d}, function () {
        ...
        }), a(this.id).on("passwdRight", {that: d}, function () {
